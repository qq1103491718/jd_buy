...
if __name__ == '__main__':
    ...
    sku_ids = '100012043978:2'  # 商品id
    area = '18_1482_48937_53602'  # 区域id
    asst = Assistant()  # 初始化
    asst.login_by_QRcode()  # 扫码登陆
    asst.buy_item_in_stock(sku_ids=sku_ids, area=area, wait_all=False, stock_interval=0.2,submit_interval=0.5)  # 根据商品是否有货自动下单
    # 6个参数：
